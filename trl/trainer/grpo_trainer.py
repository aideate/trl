...
class GRPOTrainer(Trainer):
    ...
    def _get_per_token_logps(self, model, input_ids, attention_mask, logits_to_keep):
        ...
        logits = model(
            ...
            # use_cache fallback to default value which can cause issue like https://github.com/huggingface/trl/pull/1290
            use_cache=False
        ).logits
    ...
    def _prepare_inputs(self, inputs: dict[str, Union[torch.Tensor, Any]]) -> dict[str, Union[torch.Tensor, Any]]:
        ...
        if self.args.use_vllm:
            ...
            with unwrap_model_for_generation(
                self.model, self.accelerator, gather_deepspeed3_params=self.args.ds3_gather_for_generation) as unwrapped_model:
